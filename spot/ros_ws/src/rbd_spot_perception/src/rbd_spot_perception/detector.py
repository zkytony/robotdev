...
# Note: code adapted from COS-POMDP https://github.com/zkytony/cos-pomdp/blob/master/cospomdp_apps/thor/detector.py
# /author: Kaiyu Zheng
import torch
import numpy as np
import cv2
        ...
        for xyxy, conf, objectId in bbox_detections:
            ...
            if single_loc:
                ...
                try:
                    ...
                    # sometimes bounding box is too small and projection failes
                    continue
