...
NAV_VELOCITY_LIMITS_SLOW = SE2VelocityLimit(
    min_vel=SE2Velocity(linear=Vec2(x=-0.2, y=-0.1), angular=-0.5),
    max_vel=SE2Velocity(linear=Vec2(x=0.2, y=0.1), angular=0.5))

NAV_VELOCITY_LIMITS_MEDIUM = SE2VelocityLimit(
    min_vel=SE2Velocity(linear=Vec2(x=-0.4, y=-0.2), angular=-0.6),
    max_vel=SE2Velocity(linear=Vec2(x=0.4, y=0.2), angular=0.6))
